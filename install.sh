...
THE_ARCH_BIN=''
THIS_PROJECT_NAME='go-merge-svg'
DEST_BINARY_NAME='gms'
...
curl -kL --progress-bar https://github.com/kevincobain2000/$THIS_PROJECT_NAME/releases/latest/download/$THE_ARCH_BIN -o "$BIN_DIR"/"$DEST_BINARY_NAME"

chmod +x "$BIN_DIR"/$DEST_BINARY_NAME

echo "Installed successfully to: $BIN_DIR/$DEST_BINARY_NAME"
